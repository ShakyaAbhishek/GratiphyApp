    ...
    _renderTitle() {
        return this.props.titles.map((title, index) => {
            return <TouchableOpacity
                ...
                activeOpacity = {1}
                style={{ flex: 1, flexDirection: 'row',borderBottomColor:'#eaeaea', borderBottomWidth:3, justifyContent: 'center', alignItems: 'center', backgroundColor: this.props.backgroundColor }}
