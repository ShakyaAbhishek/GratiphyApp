...
import { errorColor } from '../../../Utils/responsive';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        /> */}
        <Image style={{tintColor:errorColor}} source={require('../../../Assets/icons/picker_location.png')}/>
        <View style={styles.fullWidthContainer}>
          <AutoCompleteInput
            ref={input => (this._input = input)}
            apiKey={this.props.apiKey}
        ...
        >
          ...
          <Image style={{tintColor:errorColor}} source={require('../../../Assets/icons/GPS.png')} />
        </TouchableOpacity> */}
        <TouchableOpacity
